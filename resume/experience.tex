...
\begin{cventries}
  \cventry
    ...
    {Clustering Adjectives by Semantic Similarity and Ranking by Emotional Intensity}
    {Philadelphia, PA}
    {Summer 2016 - Present}
    {
      \begin{cvitems}
  ...
  \cventry
    ...
    {Conversational AI using Recurrent Neural Networks and Reinforcement Learning}
    {Philadelphia, PA}
    {Spring 2017}
    {
      \begin{cvitems}
        \item {Collaborated closely with Ph.D. and master students to develop an intelligent agent capable of open domain conversation.}
